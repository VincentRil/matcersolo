...
class DaftarTopikFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Dummy data
        semuaTopik = listOf(
            TopikModel("Deret Bilangan", "30 menit", 15, "25 Maret 2025", jumlahMenjawab = 9, totalPeserta = 11),
            TopikModel("Perkalian dan Pembagian", "20 menit", 10, "26 Maret 2025", jumlahMenjawab = 7, totalPeserta = 10),
            TopikModel("Pecahan", "25 menit", 12, "27 Maret 2025", jumlahMenjawab = 10, totalPeserta = 12),
            TopikModel("Desimal", "15 menit", 8, "28 Maret 2025", jumlahMenjawab = 6, totalPeserta = 8)
        )
